...
def save_chat_history(history):
    ...
    Updates chat history from prompt requests and reponses. 
...
def load_chat_history():
    ...
    return chat history if it exists else return empty list
...
def get_chat_context():
    ...
    Retrieves the last few chat interactions as context for the bot AND 
    appends into a single list to create a context for the follow up question. 
